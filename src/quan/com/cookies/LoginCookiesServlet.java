...
@WebServlet(description = "This is Servlet Hello World", urlPatterns = { "/loginCookies" }, initParams = {
		@WebInitParam(name = "username", value = "User Name not provided"),
		@WebInitParam(name = "password", value = "Pass not provided") })
public class LoginCookiesServlet<E> extends HttpServlet {
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response)
		...
		boolean check = LoginCookiesServlet.checkLogin(username, password);
		if (check) {
